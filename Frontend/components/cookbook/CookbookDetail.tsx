  ...
  return (
    <div className="space-y-8">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 text-sm text-brand-500 bg-brand-500/20 hover:text-white hover:bg-white/10 rounded-xl px-2 py-1 transition-colors group"
      >
